...
const Hero = () => {
  return (
    <motion.section
      id="home"
      className="hero pt-52 pb-24 px-6 flex flex-col items-center justify-center text-center bg-black text-white overflow-hidden min-h-screen"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 1 }}
      style={{ height: "100vh" }} // Fix height to full viewport height
    >
      ...
      <div className="w-full max-w-screen-sm mx-auto px-4">
        ...
        {/* Add the Navbar for the Emoji Links (Including Different Emoji for Blogs) */}
      </div>
    </motion.section>
  );
};
